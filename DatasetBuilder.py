#Simply open your command line and navigate to the scripts parent directory and type Python DatasetBuilder.py (For Windows only for now...) then record your dataset
